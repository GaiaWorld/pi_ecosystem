- [pi库 生态](#pi库-生态)
  - [1. crates.io 的 pi库](#1-cratesio-的-pi库)
    ...
    - [1.2. 客户端](#12-客户端)
    - [1.3. 服务器端](#13-服务器端)
  - [2. 附录一：内网 GitLab 项目](#2-附录一内网-gitlab-项目)
    - [2.1. 游戏](#21-游戏)
    - [2.2. 服务器端](#22-服务器端)
...
|[pi_render_bevy](https://github.com/GaiaWorld/pi_render_bevy)|moyy|pi_render 的 Bevy 封装||
...
|[pi_timer](https://github.com/GaiaWorld/pi_timer)|baip|基于wheel的定时轮 实现的 定时器|可能 不计划 维护，和 pi_local_timer 有重叠|
...
|链接|维护者|概述|说明|
|--|--|--|--|
|[pi_demo](http://192.168.31.243:10082/tech/pi_demo)|limh|关于上述项目的一个简单的演示例子|js项目|
|[pi_build](http://192.168.31.243:10082/tech/pi_build)|yuq|项目的构建工具，包括 资源和代码的 编译，处理，合并，压缩；并构建到各个目标平台|js项目|
|[pi_sys](http://192.168.31.243:10082/tech/pi_sys)|yuq|平台基础封装层，封装了 浏览器，小游戏，原生app，exe 等 OS和平台的差异，对外提供 统一接口|js项目|
|[pi_utils](http://192.168.31.243:10082/tech/pi_utils)|limh|js的实用数据结构和算法的封装|js项目|
|[pi_commom](http://192.168.31.243:10082/tech/pi_common)|limh|方便项目使用的通用业务逻辑代码封装， 比如：登录，支付等|js项目|
|[pi_pt](http://192.168.31.243:10082/tech/pi_pt)|luob|后端项目的封装|js项目|
...
|[pi_logger](http://192.168.31.243:10082/tech//pi_logger)|luob|基于log4rs的日志库|rust项目|
|[pi_v8](http://192.168.31.243:10082/tech/pi_v8)|zuon|v8引擎的直接封装|rust项目|
|[pi_serv](http://192.168.31.243:10082/tech/pi_serv)|zuon|后端平台的rust层， pi-pt对应的底层实现|rust项目|
|[pi_serv_lib](http://192.168.31.243:10082/tech/pi_serv_lib)|zuon||rust项目|
|[pi_serv_builtin](http://192.168.31.243:10082/tech/pi_serv_builtin)|zuon||rust项目|
|[pi_serv_ext](http://192.168.31.243:10082/tech/pi_serv_ext)|zuon||rust项目|
|[pi_core](http://192.168.31.243:10082/tech/pi_core)|zuon||rust项目|
|[pi_core_lib](http://192.168.31.243:10082/tech/pi_core_lib)|zuon||rust项目|
|[pi_core_builtin](http://192.168.31.243:10082/tech/pi_core_builtin)|zuon||rust项目|

### 2.3. 渲染 & 游戏底层

|链接|维护者|概述|说明|
|--|--|--|--|
|[babylon](http://192.168.31.243:10082/tech/babylon)|baip|对 Babylon Fork 和 修改|js项目，包括 6边形网格 和 Unity导出插件|
|[pi_babylon](http://192.168.31.243:10082/tech/pi_babylon)|baip|基于 Babylon.js，封装给项目使用的模块|js项目|
|[pi_babylon_demo](http://192.168.31.243:10082/tech/pi_babylon_demo)|baip|pi_babylon 和 Babylon 的 Demo|js项目|
|[pi_spine](http://192.168.31.243:10082/tech/pi_spine)|baip|封装 Spine.js 给项目使用的模块|js项目|

### 2.4. 平台：Android & iOS & Windows

|链接|维护者|概述|说明|
|--|--|--|--|
|[pi_packer](http://192.168.31.243:10082/tech/pi_packer)|yuq|Android 和 Windows 版本的 打包工具，打出：APK 和 Exe|js项目|
|[pi_app](http://192.168.31.243:10082/tech/pi_core_app)|zhuyijiang(zhuy)|客户端 基础框架的底层实现，类似于 微型版本的浏览器|rust项目|
|[app_start](http://192.168.31.243:10082/tech/app_start)|zhuyijiang(zhuy)|客户端启动库，主要负责 维护启动和更新方面的逻辑，包括：apk/exe，dll/so，js快照，各游戏的依赖描述文件|rust项目|
|[pi_android](http://192.168.31.243:10082/tech/pi_android)|moyy|apk的逻辑，提供 Android Java 底层功能 供 pi_sys 调用|Java项目|
|[pi_ios](http://192.168.31.243:10082/tech/pi_ios)|moyy||Swift项目|[surfman](http://192.168.31.243:10082/tech/surfman)|zhuy|网上对应库的维护，跨平台的egl 绑定|android 添加 swappy，添加ios eagl 绑定
...
|链接|维护者|概述|说明|
|--|--|--|--|
|[node_images](http://192.168.31.243:10082/tech/node-images)|moyy|pi_build 构建图片 需要 原始拷贝|添加了 CopyFromImage2 接口||
|[rusty_v8](http://192.168.31.243:10082/tech/rusty_v8)|zhuyijiang(zhuy)|v8库的rust封装|之所以自己维护，是为了构建iOS平台，以及 解决 Android 平台的构建错误|
|[winit](http://192.168.31.243:10082/tech/winit)|zhuyijiang(zhuy)|跨平台的窗口和事件提供|Android 添加虚拟键盘唤起和隐藏； exe添加自定义光标，iOS适配数据缓存，绕过某些接口必须在主线程上调用||
|[surfman](http://192.168.31.243:10082/tech/surfman)|zhuyijiang(zhuy)||EGL/WGL 封装||
|[minstant](http://192.168.31.243:10082/tech/minstant)|zhuyijiang(zhuy)|获取时间|适配iOS无法编译问题|
|[rodio](http://192.168.31.243:10082/tech/rodio)|zhuyijiang(zhuy)|音频播放库|适配 Android 播放切换问题|
|[rust-crypto](http://192.168.31.243:10082/tech/rust-crypto)|zhuyijiang(zhuy)|加密库|适配iOS无法编译链接问题||
|[font_kit](http://192.168.31.243:10082/tech/font_kit)|zhuyijiang(zhuy)|字体库|freetype_sys 的 canvas2d 封装|
|[freetype_sys](http://192.168.31.243:10082/tech/freetype_sys)|zhuyijiang(zhuy)|C代码的Rust绑定|从官网的2.6.5升级到2.10.4 & 添加了更多的Rust接口||
...
|[pi_ai](http://192.168.31.243:10082/tech/pi_ai)|废弃|rust项目，以废弃，改为 pi_path_finding|
